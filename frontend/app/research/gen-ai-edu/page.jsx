        ...
        <main className={styles.container}>
            ...
            <div className={styles.subtitleContainer}>
                <p>
                    ...
                    is a research lab at the University of Florida's College of
                    Education focused on developing and exploring new
                    methodologies for educating students in the digital world.
                </p>

                <p>
                    I received the opportunity to work with{" "}
                    <Link
                        href={"https://education.ufl.edu/faculty/leite-walter/"}
                        target="_blank"
                    >
                        Dr. Walter Leite
                    </Link>{" "}
                ...
                <p>
                    In my work with the Virtual Learning Lab, I have been a part
                    of the{" "}
                    <Link
                        href={
                ...
                <p>
                    ...
                    Project FUNLIT. Project FUNLIT is focused on the development
                    of a framework for gamifying the practice of reading. By
                    leveraging AI technologies, our research is focused on
                    developing unique, interactive, gamified experiences to
                    encourage reading practice in students.
                </p>
