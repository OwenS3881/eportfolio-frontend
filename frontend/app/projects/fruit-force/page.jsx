            ...
            <Reveal>
                <div className={styles.overview}>
                    <p>
                        ...
                        of a cast of different fruits trapped on a hostile,
                        extraterrestrial planet with the goal of escaping back
                        to their home. The player will have to navigate through
                        dangerous levels using their blaster to propel them and
                        to defend themselves against the alien species that
                        occupies the planet.
                    </p>
                </div>
            </Reveal>
            <div className={styles.links}>
                <Reveal>
                    ...
                    <div className={styles.storeLinks}>
                        <IconLink
                            platform={"Apple"}
                            href={
                                "https://apps.apple.com/us/app/fruit-force/id1585557870"
                            }
                ...
                <Reveal>
                    ...
                    <div className={styles.legal}>
                        <Link href={"/projects/fruit-force/privacy/"}>
                            Privacy Policy
                        </Link>
                        <Link href={"/projects/fruit-force/terms/"}>
                            Terms of Service
                        </Link>
                    </div>
                </Reveal>
