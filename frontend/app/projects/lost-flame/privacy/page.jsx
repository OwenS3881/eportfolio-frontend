...
export const metadata = {
  title: "Privacy Policy | Lost Flame",
};

const LostFlamePrivacy = () => {
  return (
    <div className={styles.container}>
      <Link className={styles.backButton} href={"./"}>
        Back
      </Link>
      <h2>Privacy Policy for Lost Flame</h2>

      <p>
        OCS built the Lost Flame game as a Freemium and Ad Supported game. This
        SERVICE is provided by OCS at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Lost Flame unless otherwise
...
export default LostFlamePrivacy;
